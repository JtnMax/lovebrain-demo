        ...
        {!showConfirm ? (
          ...
          >
            ...
            <div className="flex-1 flex flex-col items-center px-6 pt-2 overflow-y-auto">
              ...
              >
                <div className="absolute top-2 right-4 text-[#FFD4DE] text-lg">♥</div>
                <div className="absolute bottom-2 left-4 text-[#FFD4DE] text-sm">♥</div>
                <p className="text-xs text-[#7f8c8d] mb-2">你的邀请码</p>
                <p
                  className="text-3xl font-black text-[#FF6B8A] tracking-widest"
                ...
                <div className="flex items-center justify-center gap-3 mt-4">
                  <button
                    onClick={() => toast("邀请码已复制")}
                    className="flex items-center gap-2 bg-[#FFF0F3] px-4 py-2 rounded-full"
                  >
                    <Copy size={14} color="#FF6B8A" />
                    <span className="text-xs font-semibold text-[#FF6B8A]">复制</span>
                  </button>
                  <button
                    onClick={() => toast("分享链接已生成")}
              ...
              >
                <div className="w-32 h-32 bg-[#F7F3F0] rounded-2xl flex items-center justify-center mb-3 border-2 border-dashed border-[#e0d8d0]">
              ...
              >
                ...
                <div className="love-card flex items-center gap-3">
                  ...
                  <button
                    onClick={handleBind}
                    className="bg-[#FF6B8A] text-white text-xs font-bold px-4 py-2 rounded-full"
                  >
                    绑定
                  </button>
                </div>
            ...
            <div className="px-6 pb-8 space-y-3">
              <button
                className="btn-jelly btn-jelly-pink w-full py-4 text-base rounded-2xl flex items-center justify-center gap-2"
                onClick={() => toast("分享链接已复制")}
              >
                <Share2 size={18} />
                分享给TA
              </button>
              <button
                className="btn-jelly btn-jelly-outline w-full py-3 text-sm rounded-2xl"
                onClick={handleBind}
              >
                模拟绑定成功 →
              </button>
          ...
          >
            ...
            <p className="text-[#7f8c8d] text-center mb-6">
              你和 {MOCK_USER.partnerName} 已成功绑定
            </p>

            <div className="love-card flex items-center gap-4 w-full mb-8">
              <img src={MOCK_USER.avatar} alt="" className="w-12 h-12 rounded-full object-cover border-2 border-[#FF6B8A]" />
              <motion.div
              ...
              <img src={MOCK_USER.partnerAvatar} alt="" className="w-12 h-12 rounded-full object-cover border-2 border-[#4ECDC4]" />
              <div className="flex-1 text-right">
                <p className="font-bold text-[#2C3E50] text-sm">{MOCK_USER.partnerName}</p>
                <p className="text-xs text-[#58CC02] font-semibold">已绑定</p>
              </div>
            </div>
